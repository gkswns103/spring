...
<body>
	<table width="700" align="center">
		<tr>
			<td>
				<img src="/bbs/resources/img/title_04.gif">
			</td>
		</tr>
		...
		<tr>
			<th width="50">번호</th>
			<td>
				<img src="/bbs/resources/img/td_bg_01.gif">
			</td>
		...
		<tr>
			<td colspan="9" align="right">
				<!-- 새글 등록버튼 -->
				<img src="/bbs/resources/img/btn_reg.gif" style="cursor:pointer;" onclick="location.href='board_write.jsp?page=${param.page}'">
			</td>
		</tr>
	</table>
</body>
